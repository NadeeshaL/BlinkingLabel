...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/NadeeshaL/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'NadeeshaL' => 'nadeesha@swivelgroup.com.au' }
  s.source           = { :git => 'https://github.com/NadeeshaL/BlinkingLabel.git', :tag => s.version.to_s }
